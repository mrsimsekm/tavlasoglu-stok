...
-- Fixed to use the correct function signatures based on actual database functions
-- stok_azalt: (p_urun_id, p_depo_id, p_miktar, p_is_emri_id, p_aciklama, p_kullanici_id)
-- stok_arttir: (p_urun_id, p_depo_id, p_miktar, p_aciklama, p_kullanici_id)
